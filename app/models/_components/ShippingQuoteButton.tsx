...
export default function ShippingQuoteButton({
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
       className="mt-3 mx-auto flex w-fit items-center gap-2 rounded-full bg-[#30ab33] px-6 py-2.5 text-md font-semibold uppercase tracking-wide text-[black] transition hover:bg-[#C9D1DC] hover:text-black"
    >
